...
1. Enable students to develop mid-size software systems by experiential learning
2. Develop an impressive resume for large multinational Software Organizations by incorporating relevant information
3. Focus on building industry necessary skills to make them confident and competent professionals
...
Pedagogy: Students will create full stack applications. Assessment: weekly assignments along with CFP and CFU.
...
1. Python Project 103 : Modern Programming Practice using Python . (summer break between 1 st and 2 nd year)
2. ML projects 203: Machine learning projects are developed by applying suitable algorithms along with flask. (summer break between 2 nd and 3 rd year)
