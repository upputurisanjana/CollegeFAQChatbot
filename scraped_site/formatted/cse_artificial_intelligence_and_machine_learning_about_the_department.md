...
The Department of Computer Science and Engineering- Artificial Intelligence and Machine Learning (CSE-AIML) is established in the year 2020 with an intake of 60 students. With consistent academic excellence, the intake has been increased to 120 from the academic year 2025-26. Department has faculty with research experience and industry experience. The department has three years of students like first year, second year and third year. The present strength of the department is 180 students.
...
- Department offers best teaching & learning practices in Artificial Intelligence and Machine Learning program.
...
- Gain expertise in advanced topics such as web technologies, machine learning, deep learning, pattern recognition, computer vision, cognitive computing, human-computer interaction, generative AI, Sustainable AI etc.
- AIML students got internships in top companies like AMAZON, Microsoft, Optum, PWC, Hexagon.
- AIML students had bagged with industry projects in collaboration with companies like Hexagon in Deep Learning and Machine Learning.
- AIML students successfully completed courses offered by Simplilearn, Talentsprint, Coursera, Linkedin etc.
- Department has equipped with advanced laboratories with advanced softwares, class rooms with digital teaching resources.
- AIML faculty are upgrading their skill as per the present requirements of industry.
...
2. Problem analysis : Identity, formulate, review research literature, and analyze complex engineering problems reaching substantiated conclusions using first principles of mathematics, natural sciences, and engineering
3. Design/development of solutions: Design solutions for complex engineering problems and design system components or processes that meet the specified needs with appropriate consideration for public health and safety, and cultural, societal, and environmental
